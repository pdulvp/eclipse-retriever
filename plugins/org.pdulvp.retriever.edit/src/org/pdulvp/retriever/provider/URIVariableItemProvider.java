...
/**
 * This is the item provider adapter for a {@link org.pdulvp.retriever.URIVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class URIVariableItemProvider 
   ...
   * @generated
   */
  public URIVariableItemProvider(AdapterFactory adapterFactory) {
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_URIVariable_name_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_URIVariable_name_feature", "_UI_URIVariable_type"),
         RetrieverPackage.Literals.URI_VARIABLE__NAME,
         true,
         false,
         false,
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(URIVariable.class)) {
      case RetrieverPackage.URI_VARIABLE__NAME:
